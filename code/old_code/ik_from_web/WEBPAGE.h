...
<body>
    ...
    <p>    
    <div style="text-align: center; margin: 20px 0; padding: 15px; border: 2px solid #4CAF50; border-radius: 10px;">
      <h3>Inverse Kinematics Control</h3>
      <div style="margin: 10px 0;">
          <label for="r_input">R (radius): </label>
          <input type="number" id="r_input" value="250" min="0" max="500" step="1" style="width: 80px;">
      </div>
      <div style="margin: 10px 0;">
          <label for="theta_input">Theta (degrees): </label>
          <input type="number" id="theta_input" value="-90" min="-180" max="180" step="1" style="width: 80px;">
      </div>
      <div style="margin: 10px 0;">
          <label for="z_input">Z (height): </label>
          <input type="number" id="z_input" value="200" min="0" max="400" step="1" style="width: 80px;">
      </div>
